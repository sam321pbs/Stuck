 ...
 */
public class CardViewListFBAdapter
//    extends FirebaseRecyclerAdapter<StuckPostSimple,
...
//
//                    Intent stuckVoteIntent = new Intent(CardViewListFBAdapter.mShowPostActivity,
